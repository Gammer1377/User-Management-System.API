...
public class UserFluentConfigs : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        builder.HasData(
            new User
            {
                Id = 1, UserName = "MobinEfati", Email = "MobinEffati@gmail.com", Password = "12481632",
                CreateDate = DateTime.Now, LastUpdateDate = DateTime.Now
            },
            new User
            {
                Id = 2, UserName = "ElhamAzizzade", Email = "ElhamAzizzade@gmail.com", Password = "12481632",
                CreateDate = DateTime.Now, LastUpdateDate = DateTime.Now
            });
    }
}